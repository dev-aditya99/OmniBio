      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-24 text-center lg:pt-32">
        ...
        >
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold text-gray-900 tracking-tight mb-8">
            One link for <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">everything</span> you do.
          </h1>
          <p className="text-xl sm:text-2xl text-gray-600 mb-10 leading-relaxed">
            Connect your audience to all of your content with just one link. OmniBio is the central hub for your online presence.
          </p>
        ...
        <div className="mt-24 grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {[
            { icon: LinkIcon, title: "Unlimited Links", desc: "Add as many links as you need to your profile." },
            { icon: Share2, title: "Share Anywhere", desc: "Use your OmniBio link on Instagram, TikTok, Twitter, and more." },
            { icon: BarChart3, title: "Track Clicks", desc: "See exactly what your audience is clicking on." }
          ].map((feature, i) => (
            <motion.div
              key={i}
